...
<template>
    <header>
        ...
        <Modal v-model="updateModalShow" :mask-closable="false" :closable="false" title="版本升级">
            <div class="aboutText">
                <Card>
            ...
            <div slot="footer">
                ...
                <Button type="primary" @click="updateConfirm">确认升级，将重启应用 </Button>
            </div>
        </Modal>
    </header>
</template>
            ...
            this.$electron.ipcRenderer.on('update-message', (event, msg) => {
                ...
                switch (message) {
                    ...
                    case 'update-available':
                        ...
                        this.updateInfo = {
                            releaseDate:
                                new Date(data.releaseDate).getTime() - new Date().getTimezoneOffset() * 60 * 1000,
